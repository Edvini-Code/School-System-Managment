...
Në veçanti, është një shembull i operacioneve "Lexo" dhe "Përditëso",
 ku të dhënat lexohen nga një tabelë e bazës së të dhënave në bazë të 
 një ID të caktuar dhe pastaj shfaqen në një formë HTML për ndryshim. 
 Kodi merr vlera hyrëse nga një formë HTML të lidhura me
  informacionin e mësuesit dhe i përditëson ato në tabelën e bazës 
  së të dhënave duke përdorur një kërkesë SQL me deklaratën UPDATE.
   Në fund, kthehen mesazhe të përshtatshme në bazë të suksesit ose dështimit të operacionit.*/