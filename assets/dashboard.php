<section class="dashboard">
  ...
  justify-content: space-between;">
    <h1 style="padding:1% 4%;font-size: 34px;color:#000;width:40%;">Dashboard</h1>
    <div class="welcome_admin_message" style="width: 95%;
  border-radius:50px;
  display:flex;
  align-items:center;
 ...
 if ($time >= "19") {
  ...
  ?>
    ...
    <h1 style="font-size:35px;margin-left:200px"><?php echo date('M d, Y'); ?></h1>
      ...
      <div class="cover-img">
        <img src="images/background.jpg" alt="school img" />
        <span class="text">
          <h1></h1>
          <p>
